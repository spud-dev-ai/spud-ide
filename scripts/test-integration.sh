...
echo
bun run test-extension -- -l terminal-suggest --enable-proposed-api=vscode.vscode-api-tests
kill_app
...
echo "### Ipynb tests"
echo
bun run test-extension -- -l ipynb
kill_app

echo
echo "### Notebook Output tests"
echo
bun run test-extension -- -l notebook-renderers
kill_app
...
echo
bun run test-extension -- -l github-authentication
kill_app
